...
function Createwhatsappcampaignform(){
    ...
    {selectedImage ? (
      ...
      <>
        <label htmlFor="image-upload" style={{ cursor: 'pointer' }}>
          <FileUploadOutlinedIcon fontSize="small" sx={{ cursor: 'pointer', color: '#888', margin: '20px',marginLeft:17,marginTop:5 }} />
        </label>
        <input
          type="file"
          id="image-upload"
...
<Button variant="contained" sx={{marginLeft:65,marginTop:5,width:150,height:50,backgroundColor:'#eed9c4',color:'black','&:hover': {backgroundColor: 'White'},fontSize:23,borderRadius:2}}>
        <Link to='/WhatsappCampaignTemplate' style={{ textDecoration: 'none', color: 'inherit'}}>Create</Link> </Button>
...
export default Createwhatsappcampaignform